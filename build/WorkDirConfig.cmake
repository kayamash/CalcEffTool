...
if( NOT WorkDir_FIND_QUIETLY )
   message( STATUS "Found WorkDir: "
      "${WorkDir_ROOT_DIR} (version: 21.0.77)" )
endif()
...
set( WorkDir_BASE_PROJECTS Athena;21.0.77 )
...
set( WorkDir_PACKAGE_NAMES CalcEfficiency )
...
if( WorkDir_FIND_COMPONENTS )
   ...
   if( ATLAS_RELEASE_RECOMPILE )
      ...
      set( WorkDir_TARGET_NAMES CalcEfficiencyPkg;CalcEfficiencyPkgPrivate;CalcEfficiency;CalcEfficiencyLib )
