...
do
  ...
  echo $INPUT
  OUTPUT=$INPUT
  #OUTPUT=`echo ${OUTPUT} | sed -e "s:yfukuhar:user.yfukuhar:g"`
  OUTPUT=`echo ${OUTPUT} | sed -e "s:user.ynoguchi:user.kayamash:g"`
  OUTPUT=`echo ${OUTPUT} | sed -e "s:mc15_13TeV:user.kayamash:g"`
  OUTPUT=`echo ${OUTPUT} | sed -e "s:mc16_13TeV:user.kayamash:g"`
  #OUTPUT=`echo ${OUTPUT} | sed -e "s:data15_5TeV:user.kayamash:g"`
  #OUTPUT=`echo ${OUTPUT} | sed -e "s:data15_hi:user.kayamash:g"`
  OUTPUT=`echo ${OUTPUT} | sed -e "s:data15_13TeV:user.kayamash:g"`
  OUTPUT=`echo ${OUTPUT} | sed -e "s:data16_13TeV:user.kayamash:g"`
  OUTPUT=`echo ${OUTPUT} | sed -e "s:data17_13TeV:user.kayamash:g"`
  OUTPUT=`echo ${OUTPUT} | sed -e "s:data18_13TeV:user.kayamash:g"`
  OUTPUT=`echo ${OUTPUT} | sed -e "s:valid1:user.kayamash:g"`
